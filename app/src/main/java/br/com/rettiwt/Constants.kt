...
const val METHOD_CLEAR = "cleanDb"
...
val allMethods = listOf(METHOD_CLEAR, METHOD_AUTH, METHOD_CONNECT, METHOD_GET_ALL, METHOD_KEEP_ALIVE, METHOD_NEW_POST, METHOD_NEW_RETTIWT, METHOD_NEW_STAR, METHOD_RETTIWT, METHOD_SEND, METHOD_STAR)
